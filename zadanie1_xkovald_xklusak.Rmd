...
Spravili sme si maticu korelácie, aby sme zistili, ako navzájom korelujú hodnoty s hodnotou home_score ??? = prezistiť
Na korelačnú maticu využívame stĺpce home_score, away_score a neutral. Na výpočet korelačnej matice s týmito pamarametrami používame funkciu cor spolu s parametrom complete.obs, ktorý nám zohľadní iba riadky, ktoré nemajú chýbajúce hodnot v daných analyzovaných premenných.
